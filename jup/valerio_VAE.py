...
class VAE:
    '''
    VAE representes a Deep Convolutional 
    variational autoencoder architecture with mirrored
    ...
    def __init__(self,
        ...
        self.recontruction_loss_weight = 1000
    ...
    def _calculate_combined_loss(self, y_target, y_predicted):
        ...
        combined_loss = self.recontruction_loss_weight * reconstruction_loss + kl_loss
    ...
    def _calculate_kl_loss(self, y_target, y_predicted): # parameters are for Keras, not for this function...
    ...
    def _add_bottleneck(self, x):
        ...
        def sample_point_from_normal_distribution(args):
            ...
            #encoding data into a point in latent space
